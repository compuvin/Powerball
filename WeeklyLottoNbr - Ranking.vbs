...
'Ranking - New 9/30/13 - Updated 12/28/2015
'-----------------------
Grp1 = "2,4,5,6,9,12,16,17,18,19,20,27,29,30,31,32,40,42,46,47,53,54,56,62,64,67,68,69" 'Yellow numbers
Grp2 = Grp1 'Yellow numbers
Grp3 = Grp1 'Yellow numbers
Grp4 = Grp1 'Yellow numbers
Grp5 = "1,3,7,8,10,11,13,14,15,21,22,23,24,25,26,28,33,34,35,36,37,38,39,41,43,44,45,48,49,50,51,52,55,57,58,59,60,61,63,65,66" 'Pink numbers
'Grp5 = Grp1 & "," & "1,2,3,5,7,8,10,11,14,15,21,22,23,24,25,26,28,30,31,33,34,34,35,36,38,39,41,43,44,45,48,51,52,55,57,58,59,60,61,62,63,65,67" 'All numbers
...
'Grp1 = GrpTempAll 'removed for Ranking
OutputNote = OutputNote & vbcrlf & "'Random - Ranking" & vbcrlf
...
WriteFile format(date() + SatWed(date()), "YYYY-MM-DD") & "_PB-Numbers-Ranking.txt", OutputNote
